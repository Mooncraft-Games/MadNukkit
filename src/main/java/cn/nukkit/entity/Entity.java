    ...
    static {
        ...
        entityDataModifiers.put(
                ...
                new ProtocolEntityDataModifier(ProtocolInfo.PROTOCOL_VERSION_1_16_100)
                        .remap(DATA_AREA_EFFECT_CLOUD_RADIUS, 60)
                        .remap(DATA_AREA_EFFECT_CLOUD_WAITING, 61)
                        .remap(DATA_AREA_EFFECT_CLOUD_PARTICLE_ID, 62)
                        .remap(DATA_SHULKER_PEEK_ID, 63)
                        .remap(DATA_SHULKER_ATTACH_FACE, 64)
                        .remap(DATA_SHULKER_ATTACHED , 65)
                        .remap(DATA_SHULKER_ATTACH_POS, 66)
                        .remap(DATA_TRADING_PLAYER_EID, 67)
                        .remap(DATA_TRADING_CAREER , 68)
                        .remap(DATA_HAS_COMMAND_BLOCK, 69)
                        .remap(DATA_COMMAND_BLOCK_COMMAND, 70)
                        .remap(DATA_COMMAND_BLOCK_LAST_OUTPUT, 71)
                        .remap(DATA_COMMAND_BLOCK_TRACK_OUTPUT, 72)
                        .remap(DATA_CONTROLLING_RIDER_SEAT_NUMBER, 73)
                        .remap(DATA_STRENGTH, 74)
                        .remap(DATA_MAX_STRENGTH, 75)
                        .remap(DATA_SPELL_CASTING_COLOR, 76)
                        .remap(DATA_LIMITED_LIFE, 77)
                        .remap(DATA_ARMOR_STAND_POSE_INDEX, 78)
                        .remap(DATA_ENDER_CRYSTAL_TIME_OFFSET, 79)
                        .remap(DATA_ALWAYS_SHOW_NAMETAG, 80)
                        .remap(DATA_COLOR_2, 81)
                        .remap(DATA_NAME_AUTHOR , 82)
                        .remap(DATA_SCORE_TAG, 83)
                        .remap(DATA_BALLOON_ATTACHED_ENTITY, 84)
                        .remap(DATA_PUFFERFISH_SIZE, 85)
                        .remap(DATA_BUBBLE_TIME, 86)
                        .remap(DATA_AGENT, 87)
                        .remap(DATA_SITTING_AMOUNT, 88)
                        .remap(DATA_SITTING_AMOUNT_PREVIOUS, 89)
                        .remap(DATA_EATING_COUNTER, 90)
                        .remap(DATA_FLAGS_EXTENDED, 91)
                        .remap(DATA_LAYING_AMOUNT, 92)
                        .remap(DATA_LAYING_AMOUNT_PREVIOUS, 93)
                        .remap(DATA_DURATION, 94)
                        .remap(DATA_SPAWN_TIME, 95)
                        .remap(DATA_CHANGE_RATE, 96)
                        .remap(DATA_CHANGE_ON_PICKUP, 97)
                        .remap(DATA_PICKUP_COUNT, 98)
                        .remap(DATA_INTERACT_TEXT, 99)
                        .remap(DATA_TRADE_TIER, 100)
                        .remap(DATA_MAX_TRADE_TIER, 101)
                        .remap(DATA_TRADE_EXPERIENCE, 102)
                        .remap(DATA_SKIN_ID, 103)
                        .remap(DATA_SPAWNING_FRAMES, 104)
                        .remap(DATA_COMMAND_BLOCK_TICK_DELAY, 105)
                        .remap(DATA_COMMAND_BLOCK_EXECUTE_ON_FIRST_TICK, 106)
                        .remap(DATA_AMBIENT_SOUND_INTERVAL, 107)
                        .remap(DATA_AMBIENT_SOUND_INTERVAL_RANGE, 108)
                        .remap(DATA_AMBIENT_SOUND_EVENT_NAME, 109)
                        .remap(DATA_FALL_DAMAGE_MULTIPLIER, 110)
                        .remap(DATA_NAME_RAW_TEXT, 111)
                        .remap(DATA_CAN_RIDE_TARGET, 112)
                        .remap(DATA_LOW_TIER_CURED_DISCOUNT, 113)
                        .remap(DATA_HIGH_TIER_CURED_DISCOUNT, 114)
                        .remap(DATA_NEARBY_CURED_DISCOUNT, 115)
                        .remap(DATA_NEARBY_CURED_DISCOUNT_TIMESTAMP, 116)
                        .remap(DATA_HITBOX, 117)
                        .remap(DATA_IS_BUOYANT, 118)
                        .remap(DATA_BUOYANCY_DATA, 119)
        );
