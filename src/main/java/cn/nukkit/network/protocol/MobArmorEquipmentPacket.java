...
public class MobArmorEquipmentPacket extends DataPacket {
    ...
    public void encode() {
        ...
        this.putSlot(this.slots[0], this.protocol);
        this.putSlot(this.slots[1], this.protocol);
        this.putSlot(this.slots[2], this.protocol);
        this.putSlot(this.slots[3], this.protocol);
    }
}
